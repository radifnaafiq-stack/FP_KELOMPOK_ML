...
if not os.path.exists(MODEL_FILE):
    file_id = "1slVKcK1Gnj224NFST21ppOevzOZdM3jt"
...
<h1>
🚬 Perbandingan Algoritma Machine Learning Dalam Klasifikasi Status Merokok Berdasarkan Data Kesehatan
</h1>

<p>
Sistem ini dirancang untuk memprediksi status merokok seseorang berdasarkan 
data kesehatan menggunakan berbagai algoritma Machine Learning.
Selain melakukan prediksi, sistem juga membandingkan performa setiap algoritma
untuk menentukan model dengan tingkat akurasi terbaik.
</p>
